window.PLAYBOOK = {
  ...
  gateItems: [
    ...
    { id: "g2", label: "Credit DD completed; ECL gap quantified and priced", hard: true, weight: 3 },
    { id: "g3", label: "Legal change-of-control path clear with regulator", hard: true, weight: 3 },
    { id: "g4", label: "No uncapped material litigation without indemnity", hard: true, weight: 2 },
    { id: "g5", label: "Tax exposures quantified; escrow / indemnity agreed", hard: false, weight: 2 },
    { id: "g6", label: "IT / cyber risk acceptable or CapEx reserved", hard: false, weight: 2 },
    { id: "g7", label: "Key management retention plan signed", hard: false, weight: 2 },
    { id: "g8", label: "Minority / local ownership structure politically viable", hard: false, weight: 2 },
    { id: "g9", label: "Funding & capital plan sustains CAR post-close", hard: true, weight: 3 },
    { id: "g10", label: "100-day transformation plan resourced (people + budget)", hard: false, weight: 2 },
    { id: "g11", label: "IC paper includes explicit no-go triggers", hard: true, weight: 2 },
